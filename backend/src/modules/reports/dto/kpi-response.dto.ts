...
export class KpiResponseDto {
    ...
    @ApiProperty({ description: 'Monthly recurring revenue', example: 125000.5 })
    monthlyRecurringRevenue: number;

    @ApiProperty({ description: 'Total outstanding amount', example: 12500.0 })
    ...
    @ApiProperty({ description: 'Total overdue amount', example: 5400.0 })
    overdueAmount: number;

    @ApiProperty({ description: 'Total revenue for the period', example: 450000.0 })
    totalRevenue: number;
