...
export class TenantsService {
     ...
     */
    async create(createDto: CreateTenantDto, companyId: string): Promise<Tenant> {
     ...
     */
    async blacklist(id: string, companyId: string, reason?: string): Promise<Tenant> {
        const tenant = await this.findOne(id, companyId);
        ...
        if (reason) {
            ...
            tenant.notes = tenant.notes ? tenant.notes + blacklistNote : blacklistNote;
        }
