...
export class OccupanciesController {
  ...
  @ApiQuery({ name: 'status', required: false, enum: ['pending', 'active', 'ended', 'cancelled'] })
  ...
  findByApartment(
    ...
    return this.occupanciesService.findByApartment(
      apartmentId,
      user.companyId,
    );
  }
  ...
  recordDepositPayment(
    ...
    return this.occupanciesService.recordDepositPayment(
      id,
      user.companyId,
      amount,
    );
